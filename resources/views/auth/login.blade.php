...
<body class="hold-transition green layout-top-nav">
  <header class="main-header">
    <nav class="navbar navbar-static-top">
      ...
      <a href="{{route('dashboard')}}" class="navbar-brand">SPARK <b>PRESSING</b></a>
...
<div class="login-box">
  <div class="login-logo">
    <a href="{{route('dashboard')}}">SPARK <b>PRESSING</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form method="POST" action="{{ route('login') }}">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-6">
          <button type="submit" class="btn btn-primary btn-raised btn-block btn-flat">connexion</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
